...
RSpec.describe MeasurementValidations::Creator do
  ...
  context 'valid' do
    it 'saves object' do
      expect { subject }.to change { MeasurementValidation.count }.by 1
      expect(MeasurementValidation.last.created_by_id).to eq user.id
    end
  end
  ...
  context 'invalid' do
    context 'object validations failed' do
      ...
      it 'does not save the object' do
        ...
        expect(validation).to be_new_record
